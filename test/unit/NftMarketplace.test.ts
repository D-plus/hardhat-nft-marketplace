...
!developmentChains.includes(network.name)
	...
	: describe("Nft Marketplace Unit Tests", function () {
			...
			beforeEach(async () => {
				...
				nftMarketplace = nftMarketplaceContract.connect(deployer); // when functions on nftMarketplace contract called they will be called on behalf of connected account which is "deployer" in this case
